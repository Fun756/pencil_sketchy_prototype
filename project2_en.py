...
Label(root, text='Higher the value stronger the Noise reduction (Default: 5)', bg='#F0F8FF', font=('arial', 10, 'normal')).place(x=14, y=88)
...
Label(root, text='Percent threshold that cut the photo Hist at both side (Default: 1)', bg='#F0F8FF', font=('arial', 10, 'normal')).place(x=14, y=158)
...
Label(root, text='Mask Size of the Sobel Filter (Default: 3)', bg='#F0F8FF', font=('arial', 10, 'normal')).place(x=14, y=238)
...
Label(root, text='Mask Size for Gaussian Blur function (Default:15)', bg='#F0F8FF', font=('arial', 10, 'normal')).place(x=14, y=318)
...
Label(root, text="the additional algorithm for enhancing a photo's details. (Default: Disabled)", bg='#F0F8FF', font=('arial', 10, 'normal')).place(x=14, y=398)

# This is the section of code which creates a checkbox
CVSketch=Checkbutton(root, text='Click to Enable', variable=Is_CVsketch, bg='#F0F8FF', font=('arial', 12, 'normal'))
